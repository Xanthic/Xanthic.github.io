...
The following shows how to manually create a cache with custom settings:
...
- [baeldung.com/spring-cache-tutorial](https://www.baeldung.com/spring-cache-tutorial)
...
The list of cache names provided in the constructor needs to be complete, no further caches can be registered at runtime.
