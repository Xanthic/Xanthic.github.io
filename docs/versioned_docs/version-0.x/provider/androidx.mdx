...
Note: other Android-compatible implementations (e.g., [Cache2k](/provider/cache2k)) may yield better performance when entry expiration is enabled.
...
<Alert severity="info" variant="outlined">AndroidX requires the <a href="https://developer.android.com/studio/build/dependencies#google-maven">Google Maven</a> repository.</Alert>
