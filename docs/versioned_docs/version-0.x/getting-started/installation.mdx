...
<JavaDependency group="io.github.xanthic.cache" name="cache-bom" version="0.3.0" bom="true" scope="api" />
...
<JavaDependency group="io.github.xanthic.cache" name="cache-bom" version="0.3.0" bom="true" scope="implementation" />
